...
Note that the static build for the UFS Atmosphere model produces group 
...
performance and efficient memory use. The static build requires metadata provided 
...
* Autogenerated API for static build (aka CCPP-Framework).
