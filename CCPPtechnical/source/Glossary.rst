...
.. glossary::
   ...
   *CCPP-Physics*
   ...
   Group *cap*
      Autogenerated interface between a group of physics schemes and the host model.
   ...
   Multi-suite CCPP build
      A CCPP build type in which a set of physics suites is specified
   ...
   Suite *cap*
      ...
      They consist of calls to autogenerated group caps. They may be used to call an entire suite
